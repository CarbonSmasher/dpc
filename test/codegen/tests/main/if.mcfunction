...
execute store success score %rtest_main1 _r if predicate foo:bar
execute if score %rtest_main1 _r matches 1 run say True
execute if score %rtest_main1 _r matches 0 run say False

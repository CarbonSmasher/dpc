...
# === player:hud/refresh === #
scoreboard players set %rplayer_hud_refresh0 _r 0
execute if score @s item.id matches 2 run scoreboard players operation %rplayer_hud_refresh0 _r = @s cd.item.wrath
execute if score @s item.id matches 18 run scoreboard players operation %rplayer_hud_refresh0 _r = @s cd.item.sdagger
execute if score @s item.id matches 39 run scoreboard players operation %rplayer_hud_refresh0 _r = @s cd.item.gsword
execute if score @s item.id matches 52 run scoreboard players operation %rplayer_hud_refresh0 _r = @s cd.item.cshard
execute if score @s item.id matches 69 run function player:hud/refresh_body_0
execute store success score %rplayer_hud_refresh1 _r if score %rplayer_hud_refresh0 _r matches 1..
execute if score %rplayer_hud_refresh1 _r matches 1 run function player:hud/refresh_body_1
execute if score %rplayer_hud_refresh1 _r matches 0 run function player:hud/refresh_body_2
xp set @s 5 levels
scoreboard players operation %rplayer_hud_refresh0 _r /= %l20 _l
execute if score %rplayer_hud_refresh0 _r matches 1.. store result score %rplayer_hud_refresh1 _r run scoreboard players add %rplayer_hud_refresh0 _r 1
scoreboard players set %rplayer_hud_refresh0 _r 1
execute if score @s item.id matches 2 run scoreboard players set %rplayer_hud_refresh0 _r 30
execute if score @s item.id matches 18 run scoreboard players set %rplayer_hud_refresh0 _r 10
execute if score @s item.id matches 39 run scoreboard players set %rplayer_hud_refresh0 _r 2
execute if score @s item.id matches 52 run scoreboard players set %rplayer_hud_refresh0 _r 15
execute if score %rplayer_hud_refresh2 _r matches 1 run xp set @s 0 points
execute if score %rplayer_hud_refresh2 _r matches 2 run xp set @s 1 points
execute if score %rplayer_hud_refresh2 _r matches 3 run xp set @s 2 points
execute if score %rplayer_hud_refresh2 _r matches 4 run xp set @s 3 points
execute if score %rplayer_hud_refresh2 _r matches 5 run xp set @s 4 points
execute if score %rplayer_hud_refresh2 _r matches 6 run xp set @s 5 points
execute if score %rplayer_hud_refresh2 _r matches 7 run xp set @s 6 points
execute if score %rplayer_hud_refresh2 _r matches 8 run xp set @s 7 points
execute if score %rplayer_hud_refresh2 _r matches 9 run xp set @s 8 points
execute if score %rplayer_hud_refresh2 _r matches 10 run xp set @s 9 points
execute if score %rplayer_hud_refresh2 _r matches 11 run xp set @s 10 points
execute if score %rplayer_hud_refresh2 _r matches 12 run xp set @s 11 points
execute if score %rplayer_hud_refresh2 _r matches 13 run xp set @s 12 points
execute if score %rplayer_hud_refresh2 _r matches 14 run xp set @s 13 points
execute if score %rplayer_hud_refresh2 _r matches 15 run xp set @s 14 points
execute if score %rplayer_hud_refresh2 _r matches 16 run xp set @s 15 points
execute if score %rplayer_hud_refresh2 _r matches 17 run xp set @s 16 points
execute if score %rplayer_hud_refresh2 _r matches 18 run xp set @s 17 points
execute if score %rplayer_hud_refresh2 _r matches 19 run xp set @s 18 points
...
scoreboard players operation %rplayer_hud_refresh0 _r = @s cd.item.chainsaw
scoreboard players operation %rplayer_hud_refresh0 _r /= %l5 _l

# === player:hud/refresh_body_1 === #
scoreboard players operation %rplayer_hud_refresh2 _r = %rplayer_hud_refresh0 _r
scoreboard players operation %rplayer_hud_refresh2 _r %= %l20 _l

# === player:hud/refresh_body_2 === #
xp set @s 0 levels
xp set @s 0 points
scoreboard players reset %rplayer_hud_refresh2

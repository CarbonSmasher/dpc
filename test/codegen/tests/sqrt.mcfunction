...
scoreboard players set %rtest_main4 _r 4
scoreboard players set output int 4
execute if score %rtest_main0 _r matches ..13924 run function test:sqrt1
execute if score %rtest_main0 _r matches 13925..16777216 run function test:sqrt2
execute if score %rtest_main0 _r matches 16777217.. run function test:sqrt3
...
scoreboard players operation output int /= %l2 _l
scoreboard players operation %rtest_main4 _r /= output int
scoreboard players operation output int += %rtest_main4 _r
scoreboard players operation output int /= %l2 _l

...
# === test:main === #
scoreboard players set atest_sine0 _r 104
function test:sine
scoreboard players operation %rtest_main0 _r = rtest_sine0 _r
scoreboard players set atest_sine0 _r 104
function test:sine
scoreboard players operation %rtest_main0 _r = rtest_sine0 _r
scoreboard players set atest_sine0 _r 1660
function test:sine
scoreboard players operation %rtest_main0 _r = rtest_sine0 _r
...
scoreboard players operation %rtest_sine0 _r %= %l1800 _l
